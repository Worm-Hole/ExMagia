...
scoreboard players set @s Magia.Cooldown 200
scoreboard players set @s Magia.ManaRegenStop 200
scoreboard players remove @s Magia.Mana 30000

weather thunder
$execute at @e[tag=Magia.target,scores={Magia.PlayerIDmem=$(tempid)}] run function magia:main/magia/catastropha/lightning_sphere/target
