...
summon marker ~ ~ ~ {Tags:["Magia.Tick","Magia.This","Magia.LS.Main"],data:{Magia:{tick:{run:"catastropha/lightning_sphere/tick"}}}}
...
summon item_display ~ ~40 ~ {brightness:{sky:15,block:15},Tags:["Magia.This2"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[1f,0f,0f,1f],translation:[0f,0f,0f],scale:[1f,0.1f,1f]},item:{id:"minecraft:slime_ball",Count:1b,tag:{CustomModelData:1000}}}
